...
## Instructions
Before running any commands, proceed to the folder ./team27/team27
...
For the best user experience please have the window in fullscreen.
...
**To upload resume:**
1) Press on the “Upload Resume” button under the information section.
2) Click on the part where it says “Drag ‘n’ drop your resume” in order to pick a file to upload
3) Under our team27 folder, proceed under images and pick the pdf file with the title sampleResume.pdf (we hard coded  this part because we don’t actually have a database yet to store the files).
4) Then click on post.
